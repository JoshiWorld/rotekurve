...
export function CreateDatenschutz() {
  ...
  const createAboutus = api.datenschutz.create.useMutation({
    onSuccess: () => {
      router.push("/internal");
      toast("Datenschutz wurde erstellt", {
        description: "Datenschutz hinzugefügt",
      });
    },
  });
